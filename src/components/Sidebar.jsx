...
export function Sidebar({ currentPage, onNavigate, onLogout, mobileOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-[88px] z-30 flex h-[calc(100vh-88px)] w-64 flex-col justify-between border-r border-[rgba(28,139,255,0.22)] bg-[linear-gradient(180deg,rgba(2,15,35,0.98),rgba(2,11,27,0.99))] p-4 shadow-2xl backdrop-blur-2xl transition-transform duration-300 ease-in-out lg:translate-x-0',
